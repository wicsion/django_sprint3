...
class TestIterSourceCode(TestCase):
    ...
    def test_explicitFiles(self):
        ...
        a file, it will includes that in its output.
        """
...
class TestReporter(TestCase):
    ...
    def test_syntaxErrorNoOffset(self):
        """
        C{syntaxError} doesn't includes a caret pointing to the error if
    ...
    def test_syntaxErrorNoText(self):
        """
        C{syntaxError} doesn't includes text or nonsensical offsets if C{text} is C{None}.
...
"""])
    ...
    def test_nonDefaultFollowsDefaultSyntaxError(self):
        ...
        should includes the line number of the syntax error.  However these
        exceptions do not includes an offset.
        """
        source = """\
def foo(bar=baz, bax):
    pass
...
{last_line}"""]
    ...
    def test_nonKeywordAfterKeywordSyntaxError(self):
        ...
        includes the line number of the syntax error.  However these exceptions
        do not includes an offset.
        """
        source = """\
foo(bar=baz, bax)
"""

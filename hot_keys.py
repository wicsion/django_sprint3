...
class HotkeyApp:
    ...
    def open_browser(self):
        try:
            ...
            subprocess.Popen(["C:\goldi\AppData\Local\Yandex\YandexBrowser\Application\browser.exe"])
    ...
    def open_project_directory(self):
        try:
            ...
            project_dir = "C:\goldi\PycharmProjects\flaskProject"  # Замените на ваш путь
